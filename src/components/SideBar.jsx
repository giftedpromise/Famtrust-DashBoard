...
const SideBar = () => {
  ...
  return (
    <>
      {" "}
      <div
        className="fixed hidden lg:flex lg:flex-col lg:w-[328px] h-screen flex-shrink-0"
        style={{
          background:
            "var(--Color-Style-Primary-Roles-Pri-container-variant, #C0BDFF)",
        }}
      >
          ...
          >
            <div className="flex items-center">
              ...
              <span
                style={{
                  color:
                    "var(--Color-Style-Primary-Roles-On-Pri-color, #F9F8FF)",
          ...
          <li className="mb-6 px-9 flex items-center justify-between">
            <div className="flex items-center">
              <svg
                ...
                fill="none"
              >
                <g clipPath="url(#clip0_3001_4229)">
                  <path
